...
"""unitree_go2_spatial variant that swaps SpatialMemory for SpatialMemoryBounded."""
...
unitree_go2_spatial_bounded = autoconnect(
    unitree_go2,
    SpatialMemoryBounded.blueprint(),
    PerceiveLoopSkill.blueprint(),
    SecurityModule.blueprint(camera_info=GO2Connection.camera_info_static),
).global_config(n_workers=8)

__all__ = ["unitree_go2_spatial_bounded"]
