...
all_blueprints = {
    ...
    "unitree-go2-spatial-bounded": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_spatial_bounded:unitree_go2_spatial_bounded",
    "unitree-go2-spatial-no-security": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_spatial_no_security:unitree_go2_spatial_no_security",
...
all_modules = {
    ...
    "assistant-speech-node-ja": "dimos.agents.skills.speak_skill_ja.AssistantSpeechNodeJa",
    "azure-voice-live-agent": "dimos.agents.realtime.azure_voice_live.AzureVoiceLiveAgent",
    ...
    "japanese-web-input": "dimos.agents.web_human_input_ja.JapaneseWebInput",
    ...
    "local-microphone-ja": "dimos.agents.local_microphone_ja.LocalMicrophoneJa",
    ...
    "ptt-keyboard": "dimos.agents.realtime.ptt_keyboard.PttKeyboard",
    ...
    "spatial-memory-bounded": "dimos.perception.spatial_perception_bounded.SpatialMemoryBounded",
    ...
    "timed-mcp-client": "dimos.agents.mcp.mcp_client_ja.TimedMcpClient",
    ...
    "web-input-audio-only": "dimos.agents.web_input_audio_only.WebInputAudioOnly",
    "websocket-vis-module": "dimos.web.websocket_vis.websocket_vis_module.WebsocketVisModule",
    "whisper-human-input-ja": "dimos.agents.whisper_human_input_ja.WhisperHumanInputJa",
